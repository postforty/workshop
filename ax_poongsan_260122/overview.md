...
|            Suno      |         |  생성형 인공지능 음악 제작 플랫폼         |   |                                  https://suno.com/                                  |
...
| **2일차** | **이미지<br>생성·편집** | 9교시 | 50분 | 비주얼 콘텐츠 생성 | - AI 이미지 생성 및 업무 활용 | Nano Banana |
| | | 10교시 | 50분 | 비디오 콘텐츠 제작<br/>음악 콘텐츠 제작 | - AI 비디오 생성 및 업무 활용<br/>- AI 음악 생성 및 업무 활용 | Veo, Suno|
| | **문서·업무<br>자동화** | 11교시 | 50분 | 다이어그램 시각화<br />문서 포맷 변환 자동화 | - (직접 코딩하지 않는) 코딩 기반 플로우차트 및 마인드맵 자동 생성<br />- 파일 간 포맷 변환 및 웹 PDF 일괄 저장 | Mermaid, Pandoc, Web to PDF |
| | | 12교시 | 50분 | n8n 기초 및 트리거 이해 | - n8n 환경 설정, 노드 구조 및 기본 작동 원리 학습 | n8n |
| | | 13교시 | 50분 | 데이터 연동 및 처리 실무 | - Google Sheets, Gmail 등 주요 앱 연동 실습 | n8n |
| | | 14교시 | 50분 | AI 통합 워크플로우 구축 | - n8n AI 노드를 활용한 워크플로우 및 에이전트 제작 | n8n |
